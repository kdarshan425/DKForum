...
$to = "darshan.khope19@pccoepune.org";
$subject = "New reply for your question";
...
<body>
    ...
    <center>
        <div style=" max-width:600px;padding:30px;" >            
            <h3 style="font-size:30px;    font-family: "Orbitron", sans-serif;">Welcome To DKForum !</h3>
            <div style="padding-top: 10px;">
                <h4 style="text-align:start;">
                Hi '.$posted_by.',We are glad to have you as a part of DKForum! 
                One of the biggest community of Web Developement.
                </h4>
                <h4 style="text-align:start;">
                You have got new reply on your question, Check that
                </h4>
                <div style="padding:40px;">
                <a style="color:white" href="http://localhost/dk/" class="btn1">Check</a>
                </div>   
...
// More headers
$headers .= 'From: <kdarshan425@gmail.com>' . "\r\n";
    ...
    while($row = mysqli_fetch_assoc($result)){
        ...
        echo '<div class="media my-3">
            ...
            <div class="media-body">
               <p class="font-weight-bold my-0">'. $row2['user_email'] .' <br>at '. $comment_time. '</p> '. $content . '
            </div>
        </div>';
